...
Both APs are on their backs, four feet up. The 730 datasheet says these antennas are optimised for horizontal ceiling mount, with peak gain thirty to forty degrees off the AP's axis. Flip the AP over and that peak points above horizontal; my receiver sat twenty degrees below it. The Sidekick was fifty to sixty degrees off the main lobe, and I had put zero in that slot. The same slot I'd spent a whole section telling you never to put zero in.

At sixty degrees off the main lobe of a 5.5 dBi antenna, five or six dB down is the ordinary answer and zero down is the strange one. Read plainly, the measurement leans mildly the other way. It doesn't settle anything. Two unmeasured shapes, one equation, and an answer that landed on the number I was hoping for.
